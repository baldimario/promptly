    ...
    <div className="flex flex-1 justify-center py-5 px-4 md:px-8 lg:px-16 xl:px-40">
      <div className="flex flex-col w-full max-w-[640px] py-5 flex-1">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex max-w-[640px] flex-wrap items-end gap-4 px-4 py-3">
            <label className="flex flex-col min-w-40 flex-1">
              <span className="text-sm font-medium mb-1 text-text-muted">Prompt Text <span className="text-red-500">*</span></span>
              <textarea 
                name="promptText"
          ...
          <div className="flex max-w-[640px] flex-wrap items-end gap-4 px-4 py-3">
            <label className="flex flex-col min-w-40 flex-1">
              <span className="text-sm font-medium mb-1 text-text-muted">Example Outputs</span>
              <textarea 
                name="exampleOutputs"
                placeholder="Paste example outputs generated by your prompt"
